...
public class PiglinBrutePlagueSymbiosis extends HierarchicalModel<PlaguePiglinBruteEntity>
{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TE.MODID, "piglin_brute_plague_symbiosis"), "main");
    ...
    public PiglinBrutePlagueSymbiosis(ModelPart root)
    {
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        group5_4.addOrReplaceChild("cube_0", CubeListBuilder.create().texOffs(48, 53).addBox(-1.F, -4.5F, -1.F, 2.F, 9.F, 2.F, new CubeDeformation(0.F)), PartPose.offsetAndRotation(-2.F, 0.75F, 1.4F, -0.96711F, -0.32864F, 0.34824F));
        group5_4.addOrReplaceChild("cube_1", CubeListBuilder.create().texOffs(48, 53).addBox(-1.F, -4.5F, -1.F, 2.F, 9.F, 2.F, new CubeDeformation(0.F)), PartPose.offsetAndRotation(1.5F, 1.85F, -0.1F, -0.55575F, -0.04779F, 0.81585F));
        ...
        group6_5.addOrReplaceChild("cube_2", CubeListBuilder.create().texOffs(48, 32).addBox(-1.F, -4.5F, -1.F, 2.F, 10.F, 2.F, new CubeDeformation(0.F)), PartPose.offsetAndRotation(0.F, 3.4F, 3.25F, -1.00924F, -0.14559F, -0.27938F));
        group6_5.addOrReplaceChild("cube_3", CubeListBuilder.create().texOffs(48, 32).addBox(-1.F, -4.5F, -1.F, 2.F, 10.F, 2.F, new CubeDeformation(0.F)), PartPose.offsetAndRotation(0.F, 2.4F, -0.65F, 0.11989F, -0.19966F, -0.94404F));
        ...
        group4_11.addOrReplaceChild("cube_11", CubeListBuilder.create().texOffs(48, 53).addBox(-1.F, -4.5F, -1.F, 2.F, 9.2F, 2.F, new CubeDeformation(0.F)), PartPose.offsetAndRotation(0.F, 1.85F, -0.9F, 0.18718F, 0.04294F, 0.34437F));
    ...
    @Override
    public void setupAnim(PlaguePiglinBruteEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
