...
public class ZombieInfectionOuterLayer<T extends Zombie> extends RenderLayer<T, ZombieInfection<T>>
{
    ...
    private final ZombieInfection<T> model;

    public ZombieInfectionOuterLayer(RenderLayerParent<T, ZombieInfection<T>> parent, EntityRendererProvider.Context context)
    {
        super(parent);
        this.model = new ZombieInfection<>(context.bakeLayer(ZombieInfection.OUTER_LAYER_LOCATION));
    }
